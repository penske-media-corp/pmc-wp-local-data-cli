<?php
/**
 * Retain `profiles-landing-page` (or customized slug) objects.
 *
...
/**
 * Class PMC_Profiles_Landing_Page.
 */
final class PMC_Profiles_Landing_Page extends Query_Args {
	/**
	...
	public static function get_query_args(): array {
		return [
			'post_type' => Post_Type::get_instance()->get_landing_page_post_type_slug(),
		];
	}
