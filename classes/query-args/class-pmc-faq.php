<?php
/**
 * Retain post objects that contain meta data for FAQs.
 *
 ...
 * Class PMC_FAQ.
 */
final class PMC_FAQ extends Query_Args {
	/**
	 * Skip processing posts flagged as FAQs since they have no dependencies.
	 *
	 * @var bool
	 */
